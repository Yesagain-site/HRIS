...
// export interface PerformanceAppraisal {
//     managerEvaluation: number; // Percentage
//     attitudeNotes: string;
// }
...
// export interface AuditTrail {
//     createdBy: string; // employeeId or username
//     createdAt: string; // ISO date string
//     lastEditedBy?: string; // employeeId or username
//     lastEditedOn?: string; // ISO date string
// }
...
//     productivityScore?: number;
//     leaveBalances: Record<string, LeaveBalance>;
//     // Derived property, not stored in mock data
//     name?: string; 
// }
...
//     payComponents: PayComponent[];
//     payCycle: PayCycle;
//     payCycleCustomDate?: number; // 1-28
//     roundingRule: RoundingRule;
//     glCodeMappings: GLCodeMapping[];
//     payrollPeriodStartDate: string; // YYYY-MM-DD
//     payrollPeriodEndDate: string; // YYYY-MM-DD
// }
...
//     fiscalYearStartMonth?: number;  // Add this
//     workWeekStart: number;
//     defaultWorkHoursPerDay: number;
//     overtimeRate: number;
//     leaveApprovalWorkflow: string;
//     payrollCycle: 'Monthly' | 'Bi-Weekly' | 'Weekly';
//     uiSettings: UIThemeSettings;  // Make this required, not optional
//     enabledModules: {  // Make this required
//         payroll: boolean;
//         attendance: boolean;
//         training: boolean;
//         appraisals: boolean;
//     };
//     documentExpiryRules: {  // Make this required
//         passport: number[];
//         visa: number[];
//         eid: number[];
//     };
//     customFields: CustomFieldDef[];  // Make this required
//     payrollSettings: PayrollSettings;  // Make this required
//     attendanceRules: AttendanceRule;  // Make this required
//     integrationSettings: IntegrationSettings;  // Make this required
//     notificationSettings: NotificationSetting[];  // Make this required
// }
...
// export interface ResignationRequest extends BaseRequest {
//     proposedLastDay: string; // YYYY-MM-DD
// }
